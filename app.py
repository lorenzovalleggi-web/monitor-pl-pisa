...
N_PL = ["Via Ugo Rindi", "Via di Gagno", "Via XXIV Maggio", "Via U. Dini (Gello)", "San Giuliano Terme"]
A_I, A_F = [-4, -4, -3, -1, 1], [2, 2, 3, 5, 7]
R_I, R_F = [15, 15, 14, 11, 9], [21, 21, 20, 17, 15]
