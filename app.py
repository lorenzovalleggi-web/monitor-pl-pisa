...
with streamlit_analytics.track():
    ...
    st.caption("💡 *Nota per l'amministratore: aggiungi '?analytics=on' in fondo al link della tua app per vedere il pannello di controllo dettagliato delle visite.*")
