...
# USIAMO I CODICI DEL SITO MOBILE (MOLTO PIÙ ACCESSIBILI)
# Codice stazione San Giuliano Terme per API Mobile: N00213 o S06105. Proviamo il sistema a fallback completo.
...
# Camuffamento avanzato: facciamo finta di essere un browser Safari su iPhone
headers = {
...
try:
    ...
    # Proviamo a scaricare le partenze con sessione pulita
    with requests.Session() as session:
        ...
        try:
            ...
            pass # se fallisce una non blocchiamo tutto
    ...
    # Se i server principali falliscono, proviamo l'ultimo endpoint disperato (Regione Toscana)
    if not treni_rilevati:
        # Interroghiamo l'andamento generale della stazione
    ...
    # Analisi della lista treni ottenuta
    for treno in treni_rilevati:
        ...
        try:
            # Pulisce l'orario se contiene date o scritte strane
            if " " in orario_str:
        ...
        # Finestra temporale: 6 minuti prima, 2 minuti dopo
