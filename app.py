...
with st.container():
    ...
    st.write("Aiutaci a coprire i costi dei server per mantenere i dati active 24/7.")
    st.markdown(
...
st.markdown("---")
st.write("© 2026 **BinarioLibero Pisa**. Contatti: [info.railflow@gmail.com](mailto:info.railflow@gmail.com)")
